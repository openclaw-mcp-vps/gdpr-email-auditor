# Build Task: gdpr-email-auditor

Build a complete, production-ready Next.js 15 App Router application.

PROJECT: gdpr-email-auditor
HEADLINE: Audit email lists for GDPR compliance gaps
WHAT: Scans email marketing lists to identify contacts without proper consent records, suggests cleanup actions, and tracks compliance status
WHY: GDPR fines average €15M and email marketing without proper consent is the #1 violation, but manual audits are impossible at scale
WHO PAYS: E-commerce businesses, SaaS companies, marketing agencies
